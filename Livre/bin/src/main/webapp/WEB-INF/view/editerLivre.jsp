...
<form action="updateLivre" method="post">
 ...
 <input type="text" name="idLivre" value="${livre.idLivre}"
readonly class="form-control"/>
 </div>
 <div class="form-group">
 <label class="control-label">Nom Livre :</label>
 <input type="text" name="nomLivre" value="${livre.nomLivre}"
class="form-control"/>
 </div>
 <div class="form-group">
 <label class="control-label">Prix Livre :</label>
 <input type="text" name="prixLivre" value="${livre.prixLivre}"
class="form-control"/>
 </div>
 <div class="form-group">
 <label class="control-label"> Date création :</label>
 <fmt:formatDate pattern="yyyy-MM-dd" value="${livre.dateCreation}"
var="formatDate" />
